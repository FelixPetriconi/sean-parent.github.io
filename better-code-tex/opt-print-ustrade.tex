...
% TODO Fp use mage size from COP
...
\def\OPTtopmargin{1.10in}              % Margin at the top of the page
\def\OPTbottommargin{0.748in}          % Margin at the bottom of the page
\def\OPTinnermargin{0.787in}           % Margin on the inner side of the page
\def\OPTbindingoffset{0.4in}           % Extra offset on the inner side
\def\OPToutermargin{0.591in}           % Margin on the outer side of the page
